#  Shakthi 2.0 - AI Biometric Gatekeeper
...
##  Features
* ** Kernel-Level Lockdown:** Blocks `Alt+F4`, `Win`, `Tab`, and suppresses Mouse inputs completely.
* ** AI Voice Security:** Uses Deep Learning (Resemblyzer) to verify speaker identity against a stored voice print.
* ** Arc Reactor UI:** A pulsing, sci-fi visual interface built with Tkinter.
